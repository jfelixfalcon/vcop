...
import type { VirtualCluster, PoliciesSpec } from '../lib/types';
...
export const QuotaModal: React.FC<Props> = ({ cluster, isOpen, onClose, onUpdateSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-in fade-in duration-150">
      <div className="relative w-full max-w-2xl bg-cyber-900 border border-cyber-700 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* Top Glow */}
