/*
Copyright 2026 vCOp Authors (Juan Felix-Falcon)
...
import (
	...
	"github.com/vops/vc-operator/controllers"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "vcluster-operator.vops.gitops.io",
	})
	if err != nil {
	...
	setupLog.Info("starting vCluster Center of Operations Operator (vCOp)")
